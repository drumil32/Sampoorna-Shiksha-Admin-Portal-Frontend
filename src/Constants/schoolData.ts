export const school = [
    {
     ...
     "Name of the school\/Institution": "Kshetramahabaleshwar ZP school",
     "Type of institution\/school": "Others (specify)",
     "District": "Mahabaleshwar",
     "State": "Maharashtra",
     "Full address with pin code": "Zilla Parishad school, Kshetramahabaleshwar, AT post, Mahabaleshwar, District Mahahbaleshwar, Pin -412806",
    ...
    },
    {
     ...
     "Name of the school\/Institution": "Pragati wheel school",
     "Type of institution\/school": "Trust",
     "District": "Delhi",
     "State": "Delhi",
     "Full address with pin code": "C-240, Pandav Nagar, Delhi - 110092 (Near Radha Krishna Mandir, Opposite Mother Diary)",
    ...
    },
    {
     ...
     "Name of the school\/Institution": "Paras Balbhavan",
     "Type of institution\/school": "Others (specify)",
     "Village name  if any": "Titwala",
     "District": "Thane",
     "State": "Maharashtra",
     "Full address with pin code": "Paras Balbhavan, near ZP school, Maskal, Titwala (E), Taluka Kalyan, Dist Thane - 421605",
    ...
    },
    {
     ...
     "Name of the school\/Institution": "HINDU MIDDLE SCHOOL, HARIKESAVANALLUR ",
     "Type of institution\/school": "Semi aided school",
     "Village name  if any": "HARIKESAVANALLUR ",
     "District": "TIRUNELVELI ",
     "State": "Tamil Nadu",
     "Full address with pin code": "No 26, NORTH STREET , HARIKESAVANALLUR  627426",
    ...
    },
    {
     ...
     "Name of the school\/Institution": "Vivekananda vidyalayam nursery and primary school ",
     ...
     "District": "Tenkasi ",
     "State": "Tamilnadu ",
     "Full address with pin code": "20\/56 Keela avani moola veedhi,Tenkasi 627811",
    ...
    },
    {
     ...
     "Name of the school\/Institution": "Swapnopuron Shiksha Niketan",
     "Type of institution\/school": "NGO",
     "Village name  if any": "Jora Bottola, Hingalganj",
     "District": "North 24 Paragana",
     "State": "West bengal",
     "Full address with pin code": "Jora bottola, Hingalganj, North 24 paragana, 743435",
    ...
    },
    {
     ...
     "Name of the school\/Institution": "Harakade",
     "Type of institution\/school": "Others (specify)",
     "Village name  if any": "Harakade",
     "District": "Uttarkannada",
     "State": "Karnataka",
     "Full address with pin code": "Harakade, Divgi, Kumta, Uttarkannada, Karnataka - 581343.",
    ...
    },
    {
     ...
     "Name of the school\/Institution": "Gundmi ",
     "Type of institution\/school": "Others (specify)",
     "Village name  if any": "Gundmi",
     "District": "Sasthana",
     "State": "Karnataka",
     "Full address with pin code": "Anganvadi center Gundmi, Sasthana post, Karnataka- 576226.",
    ...
    },
    {
     ...
     "Name of the school\/Institution": "Ganesh Mondal",
     "Type of institution\/school": "Others (specify)",
     "Village name  if any": "Ganesh Mondal",
     "District": "North 24 Paragana",
     "State": "West Bengal",
     "Full address with pin code": "37c bediadanga, masjidbari bylane, kolkata 700040",
     "Name of the Principal and Management ": "Saratupa Majumder ",
     "Contact number of the Principal\/Management": 8420579906,
     "Name of the teacher\/coordinator for training and managing the library": "Manosij Bandhopadhay",
     "Contact details of the coordinator\/teacher": 8116424917,
    ...
    },
    {
     ...
     "Name of the school\/Institution": "Main School",
     "Type of institution\/school": "Others (specify)",
    ...
    },
    {
     ...
     "District": "North 24 Paragana",
     "State": "West bengal",
     "Full address with pin code": "37c bediadanga, masjidbari bylane, kolkata 700039",
     "Name of the Principal and Management ": "Saratupa Majumder ",
     "Contact number of the Principal\/Management": 8420579906,
     "Name of the teacher\/coordinator for training and managing the library": "Manosij Bandhopadhay",
     "Contact details of the coordinator\/teacher": 8116424917,
    ...
    },
    {
     "Code": 45,
     "Timestamp": "8\/1\/2024 12:31:07",
     "Name of the school\/Institution": "Ganesh Mondal45",
     "Board affiliated to and Medium  of instruction": "Tamil Nadu State board and English",
    ...
    },
    {
     ...
     "District": "Sawantwadi",
     "State": "maharashta",
     "Full address with pin code": "A-3\/Wanawadi, Pune 411040",
